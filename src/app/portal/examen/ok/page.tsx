...
export default function ExamenOk() {
  return (
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <div className={styles.okPage}>
          ...
          <h1 className={styles.okTitle}>¡Examen entregado!</h1>
          <p className={styles.okSub}>
            Tu examen fue recibido correctamente. El resultado estará disponible
            una vez que el docente lo revise.
          </p>
